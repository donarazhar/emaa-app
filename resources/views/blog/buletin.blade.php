...
<body class="bg-gray-100">
    ...
    <header class="bg-blue-900 text-white p-4">
        <div class="flex justify-between items-center">
            ...
            <h1 class="text-lg md:text-xl font-bold text-white">Buletin Jum'at</h1>
    ...
    <section class="p-4">
        @foreach ($buletin as $item)
            <a href="{{ route('buletin.show', ['id' => $item->id]) }}" class="block">
    ...
    <script>
        document.getElementById('searchInput').addEventListener('input', function() {
            window.location.href = '{{ route('buletin') }}?search=' + this.value;
        });
    </script>
