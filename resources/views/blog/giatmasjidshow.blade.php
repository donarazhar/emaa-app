...
<body class="bg-gray-100">
    ...
    <section class="relative bg-blue-900">
        ...
        <div class="w-full h-48 md:h-64 bg-cover bg-center"
            style="background-image: url('{{ asset('storage/' . $giatMasjid->thumbnail) }}');">
        </div>
    </section>

    <!-- Content Section -->
    <section class="p-4">
        <h2 class="text-xl md:text-2xl font-bold mb-2">{{ $giatMasjid->judul }}</h2>
